...
export default class Verify extends ValidationComponent {
    ...
    onSubmit(){    
        const { email, password, success,redirect,config,code,referral} = this.state;
        const { navigation } = this.props;
        this.setState({loading:true});
                var url=config.baseUrl+"front/api/AuthVerify/app?e="+email+"&tk="+code+"&referral_code="+referral;
