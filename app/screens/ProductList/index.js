...
export default class ProductList extends Component {
    ...
    getData(){
        ...
        AsyncStorage.getItem('config', (error, result) => {
            if (result) {    
                let config = JSON.parse(result);
                var url=config.apiBaseUrl+"product?limit="+paramCategory+paramPrice+paramCity+paramTag+paramOrder;
    ...
    getTag(){
        ...
        AsyncStorage.getItem('config', (error, result) => {
            if (result) {    
                let config = JSON.parse(result);
                var url=config.apiBaseUrl+"product/tag?"+paramCategory.replace('&','');
                ...
                fetch(url, requestOptions)
                 .then(response => response.json())
                 .then(result => {
                    //console.log('productTag',JSON.stringify(result.data));
